        ...
        <form v-if="addMode === 'manual' || editingItem" @submit.prevent="handleSubmit">
            ...
            <div class="form-section-grid">
              ...
              <div class="flex items-center pt-6">
                <label class="flex items-center gap-2 cursor-pointer">
                  <Checkbox :checked="formData.warrantyOnsite" @update:checked="formData.warrantyOnsite = $event" />
          ...
          <div class="form-section">
            ...
            <div class="form-section-grid">
              ...
              <div class="flex items-center pt-6">
                <label class="flex items-center gap-2 cursor-pointer">
                  <Checkbox :checked="formData.canBorrow" @update:checked="formData.canBorrow = $event" />
