...
const seedRequests = [
  { requestId: "REQ-001", itemID: "INV-001", borrowerID: "S00123456", status: "Pending", requestDate: "2025-02-01", approvalDate: null, approvedBy: null, returnDate: null, returnedDate: null, reason: "Course project - Computer Architecture", notes: "" },
  { requestId: "REQ-002", itemID: "INV-004", borrowerID: "S00123456", status: "Approved", requestDate: "2025-01-20", approvalDate: "2025-01-20", approvedBy: "U001", returnDate: "2025-02-20", returnedDate: null, reason: "Lab assignment - Data Visualization", notes: "Return by end of semester" },
  { requestId: "REQ-003", itemID: "INV-006", borrowerID: "S00234567", status: "Approved", requestDate: "2025-01-25", approvalDate: "2025-01-25", approvedBy: "U002", returnDate: "2025-02-25", returnedDate: null, reason: "Software development project", notes: "" },
  { requestId: "REQ-004", itemID: "INV-008", borrowerID: "S00345678", status: "Approved", requestDate: "2025-01-18", approvalDate: "2025-01-18", approvedBy: "U001", returnDate: "2025-02-18", returnedDate: null, reason: "Game development lab", notes: "High-performance needed" },
  { requestId: "REQ-005", itemID: "INV-011", borrowerID: "S00456789", status: "Approved", requestDate: "2025-01-28", approvalDate: "2025-01-28", approvedBy: "U002", returnDate: "2025-02-28", returnedDate: null, reason: "Data storage for research", notes: "" },
  { requestId: "REQ-006", itemID: "INV-007", borrowerID: "S00567890", status: "Pending", requestDate: "2025-02-01", approvalDate: null, approvedBy: null, returnDate: null, returnedDate: null, reason: "Mobile app development", notes: "" },
  { requestId: "REQ-007", itemID: "INV-009", borrowerID: "S00234567", status: "Rejected", requestDate: "2025-01-31", approvalDate: "2025-02-01", approvedBy: "U001", returnDate: null, returnedDate: null, reason: "Machine learning experiments", notes: "Item reserved for research lab" },
  { requestId: "REQ-008", itemID: "INV-002", borrowerID: "S00345678", status: "Returned", requestDate: "2025-01-10", approvalDate: "2025-01-10", approvedBy: "U001", returnDate: "2025-01-31", returnedDate: "2025-01-31", reason: "Testing and benchmarking", notes: "Returned in good condition" },
  { requestId: "REQ-009", itemID: "INV-012", borrowerID: "S00123456", status: "Pending", requestDate: "2025-02-01", approvalDate: null, approvedBy: null, returnDate: null, returnedDate: null, reason: "Audio recording for project", notes: "" },
  { requestId: "REQ-010", itemID: "INV-005", borrowerID: "S00567890", status: "Approved", requestDate: "2025-02-01", approvalDate: "2025-02-01", approvedBy: "U002", returnDate: "2025-02-15", returnedDate: null, reason: "HCI Lab experiment", notes: "" }
];
...
async function seed() {
  try {
    ...
    await BorrowRequest.insertMany(seedRequests);

    console.log('📜 Seeding audit logs...');
    await AuditLog.insertMany(seedLogs);

    // Set counters to the correct sequence values
    console.log('🔢 Setting counters...');
    await Counter.findByIdAndUpdate('item', { seq: 12 }, { upsert: true });
    await Counter.findByIdAndUpdate('request', { seq: 10 }, { upsert: true });
    await Counter.findByIdAndUpdate('log', { seq: 18 }, { upsert: true });

    console.log('');
    console.log('✅ Database seeded successfully!');
    console.log(`   - ${seedUsers.length} users`);
    console.log(`   - ${seedItems.length} inventory items`);
    console.log(`   - ${seedRequests.length} borrow requests`);
    console.log(`   - ${seedLogs.length} audit logs`);
    console.log('');
