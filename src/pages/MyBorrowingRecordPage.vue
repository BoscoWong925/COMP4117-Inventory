          ...
          <div class="p-4">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
              ...
              <div>
                ...
                <p class="font-medium">
                  ...
                  <span v-if="group.children.length > 0" class="ml-1 text-xs text-blue-600 font-normal">
            ...
            <div v-if="group.children.length > 0" class="border-t pt-3 mb-3">
              ...
              <div v-for="child in group.children" :key="child.id"
                class="flex items-center justify-between py-1.5 pl-4 text-sm text-gray-600 border-l-2 border-blue-200 mb-1">
                <div>
                  <span>↳ {{ child.itemName }}</span>
                  <span class="text-gray-400 ml-1">({{ child.id }})</span>
                </div>
